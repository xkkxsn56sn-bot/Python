...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Batch-convert Markdown files to PDF using Pandoc + xelatex with recursive scan, JSON reporting, optional GUI, and optional PDF protection."
    )
...
class App:
    ...
    def _build_ui(self):
        ...
        ttk.Checkbutton(sec, text="Protect generated PDFs", variable=self.protect_pdf_var, command=self._toggle_protection_fields).grid(row=0, column=0, columnspan=2, sticky="w", padx=8, pady=4)
        ...
        self.protection_note = ttk.Label(sec, text="Default behavior blocks print, copy, and modify. Owner password is required.")
        self.protection_note.grid(row=4, column=1, sticky="w", padx=8, pady=4)
